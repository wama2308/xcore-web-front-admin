...
class AccountGroupStore {
  ...
  get rules() {
    ...
    let rules = {
      ...
      'people.*._id': 'required|string|objectId',
    }
  ...
  get messages() {
    return {
      ...
      'people.required': 'Debe proporcionar las personas que estarán en el grupo',
      'people.array': 'Debe poporcionar un arreglo',
      'people.*._id.required': 'Proporcione un producto',
      'people.*._id.string': 'Debe proporcionar un dato alfanumerico',
      'people.*._id.objectId': 'Debe proporcionar un Objeto valido',
    }
  }
...
module.exports = AccountGroupStore
