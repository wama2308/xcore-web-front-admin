...
export default {
  category1: [
    ...
    },
    {
      ...
      child_routes: [
        {
          path: "/horizontal/sales/shop",
          new_item: false,
          menu_title: "sidebar.shop",
        },
        {
          path: "/horizontal/sales/cart",
          new_item: false,
          menu_title: "sidebar.cart",
        },
        {
          path: "/horizontal/sales/checkout",
          new_item: false,
          menu_title: "sidebar.checkout",
        },
        {
          path: "/horizontal/sales/shop-list",
          new_item: false,
          menu_title: "sidebar.shopList",
        },
        {
          path: "/horizontal/sales/shop-grid",
          new_item: false,
          menu_title: "sidebar.shopGrid",
        },
        {
          path: "/horizontal/sales/invoice",
          new_item: false,
