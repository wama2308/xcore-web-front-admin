...
class PlanesTypeClientAdd extends React.Component {
    constructor(props) {
        super(props);
        this.state = {};
    }
    ...
    delete(key) {
        const message = {
            title: "Eliminar Plan",
            info: "¿Esta seguro que desea eliminar este plan?"
        };
        this.props.confirm(message, res => {
            if (res) {
                this.props.deletePlanFunction(key);
            }
        });
    }
...
export default PlanesTypeClientAdd;