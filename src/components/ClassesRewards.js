...
class ClassesRewards extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    add(data, dataDiscountCant, option) {
        const message = {
            title: "Agregar Clase",
            info: "¿Esta seguro que desea agregar esta clase?"
        };
        this.props.confirm(message, res => {
            ...
            if (res) {
                ...
                if (acum === 0) {                    
                    this.props.addClassFunction(data, this.props.arrayAll, dataDiscountCant, option);
                    this.props.cleanSelectClass();
                }
            }
        });
    }
