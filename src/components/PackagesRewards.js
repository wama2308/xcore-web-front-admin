...
class PackagesRewards extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    add(data, dataDiscountCant, option) {
        ...
        this.props.confirm(message, res => {
            ...
            if (res) {
                ...
                if (acum === 0) {                    
                    this.props.addPackageFunction(data, this.props.arrayAll, dataDiscountCant, option);
                    this.props.cleanSelectPackage();
                }
            }
        });
    }
...
export default PackagesRewards;