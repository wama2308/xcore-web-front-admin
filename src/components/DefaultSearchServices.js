...
import { seekerServices } from "../actions/aplicantionActions";
...
class DefaultSearchServices extends React.Component {
  constructor() {
    super();
    this.state = {
      suggestions: [],
...
DefaultSearchServices.propTypes = {
  classes: PropTypes.object.isRequired
};

const mapStateToProps = state => ({
  value: state.general.seekerServices,
});

export default connect(
  mapStateToProps,
  { seekerServices }
)(withStyles(styles)(DefaultSearchServices));
