...
import { seekerProducts } from "../actions/aplicantionActions";
...
class DefaultSearchProducts extends React.Component {
  constructor() {
    super();
    this.state = {
      suggestions: [],
...
DefaultSearchProducts.propTypes = {
  classes: PropTypes.object.isRequired
};

const mapStateToProps = state => ({
  value: state.general.seekerProducts,
});

export default connect(
  mapStateToProps,
  { seekerProducts }
)(withStyles(styles)(DefaultSearchProducts));
