...
class Sidebar extends Component {
	...
	render() {
		const { enableSidebarBackgroundImage, selectedSidebarImage, isDarkSidenav, agencySidebar, dataGeneral, miniSidebar } = this.props;		
		return (
			<Fragment>
				<div
					...
					<div className={classNames("rct-sidebar-content", { "sidebar-overlay-dark": isDarkSidenav, 'sidebar-overlay-light': !isDarkSidenav })}>
						<div className="site-logo">
							<Link to="/" className="logo-mini">
								<img src={require('Assets/img/logo_xcore.png')} className="mr-15" alt="site logo" width="35" height="35" />
							</Link>
							{
								!miniSidebar && (
									<h2>XCORE</h2>
...
const mapStateToProps = ({ settings, general }) => {
	...
	return { enableSidebarBackgroundImage, selectedSidebarImage, collapsedSidebar, isDarkSidenav, locale, dataGeneral, miniSidebar };
};
