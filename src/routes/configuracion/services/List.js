...
class List extends React.Component {
    ...
    openModal = (option, data) => {
        if (option === 1) {
            this.setState({
                option: option,
                modal: true,
                modalHeader: 'Registrar Servicio',
            ...
            this.props.loadServiceIdAction(data._id)
            this.setState({
                option: option,
                modal: true,
    ...
    desactivar(id) {
        const message = {
            ...
            info: "¿Esta seguro que desea inactivar este servicio?"
        };
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Servicios Activos" fullBlock>
                {
                    this.state.modal &&
                    <ModalService
                ...
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allServicesFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allServicesFunction}
                                        />
                                    </div>
                                }
                            </div>
