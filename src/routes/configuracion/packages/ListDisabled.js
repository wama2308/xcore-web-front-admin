...
class ListDisabled extends React.Component {
    ...
    activar(id) {
        const message = {
            ...
            info: "¿Esta seguro que desea activar este paquete?"
        };
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Paquetes Inactivos" fullBlock>
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allPackagesDisabledFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                            ...
                                            {data ? data.map((data, i) => {
                                                ...
                                                return (
                                                    <TableRow hover key={i}>
                                                        ...
                                                        <TableCell style={{ width: '30%' }} align="left">{number_format(data.name, 2)}</TableCell>
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allPackagesDisabledFunction}
                                        />
                                    </div>
                                }
                            </div>
