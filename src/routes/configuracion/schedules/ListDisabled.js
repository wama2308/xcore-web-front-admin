...
class ListDisabled extends React.Component {
    ...
    activar(id) {
        const message = {
            ...
            info: "¿Esta seguro que desea activar este horario?"
        };
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Horarios Inactivos" fullBlock>
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allSchedulesDisabledFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allSchedulesDisabledFunction}
                                        />
                                    </div>
                                }
                            </div>
