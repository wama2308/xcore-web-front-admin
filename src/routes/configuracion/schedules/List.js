...
class List extends React.Component {
    ...
    openModal = (option, data) => {
        if (option === 1) {
            ...
            this.props.loadScheduleIdAction(data._id)
            this.setState({
                option: option,
                modal: true,
                modalHeader: 'Ver Horario',
                buttonFooter: 'Editar',
                disabled: true,
                showHide: true,
                data: data,
    ...
    desactivar(id) {
        const message = {
            ...
            info: "¿Esta seguro que desea inactivar este horario?"
        };
        this.props.confirm(message, res => {
            if (res) {
                this.props.changeEstatusScheduleFunction(id);
            }
        });
    }
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Horarios Activos" fullBlock>
                {
                    this.state.modal &&
                    <Modal
                ...
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allSchedulesFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allSchedulesFunction}
                                        />
                                    </div>
                                }
                            </div>
