...
class ListDisabled extends React.Component {
    ...
    activar(id) {
        const message = {
            title: "Activar Recompensa",
            info: "¿Esta seguro que desea activar esta recompensa?"
        };
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Recompensas Inactivas" fullBlock>
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allRewardsDisabledFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allRewardsDisabledFunction}
                                        />
                                    </div>
                                }
                            </div>
