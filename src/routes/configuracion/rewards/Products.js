...
class Products extends React.Component {
    ...
    handleChange = (e, id) => {
        ...
        this.props.setDataProductsQuantityRewardAction(id, e.target.value);
    };
    ...
    handleChangeSelect = (value, select, id, div) => {
        ...
        this.props.addDiscountSelectProduct(id, value);
    };
                                ...
                                }
                                {
                                    this.props.rule === 2 && (
                                        <tr>
                                            ...
                                            <td style={{ width: '30%' }} align="left">Codigo</td>
                                            ...
                                            dataSelect.map((data, key) => {
                                                return (
                                                    <tr key={key}>
                                                        ...
                                                        <td style={{ width: '30%' }} align="left">{data.code}</td>
                                                        <td style={{ width: '20%' }} align="left">
                                                            <div id={`div_quantity_${key}`} className="">
                                                                <Input
                                                                    ...
                                                                    onChange={event => this.handleChange(event, data.products_id)}
                                                                    onKeyDown={event => this.keyPress(event, data.products_id)}
                                                                    value={data.quantity}
                                                                    type="number"
                                                                    min="0"
                                                                    disabled={this.props.disabled}
