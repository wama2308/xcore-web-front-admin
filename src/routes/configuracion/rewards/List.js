...
class List extends React.Component {
    ...
    openModal = (option, data) => {
        if (option === 1) {
            this.setState({
                option: option,
                modal: true,
                modalHeader: 'Registrar Recompensa',
            ...
            this.props.loadRewardIdAction(data._id)
            this.setState({
                option: option,
                modal: true,
                modalHeader: 'Ver Recompensa',
                buttonFooter: 'Editar',
                disabled: true,
                showHide: true,
                data: data,
    ...
    desactivar(id) {
        const message = {
            title: "Inactivar Recompensa",
            info: "¿Esta seguro que desea inactivar esta recompensa?"
        };
        this.props.confirm(message, res => {
            if (res) {
                this.props.changeEstatusRewardFunction(id);
            }
        });
    }
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Recompensas Activas" fullBlock>
                {
                    this.state.modal &&
                    <Modal
                ...
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allRewardsFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allRewardsFunction}
                                        />
                                    </div>
                                }
                            </div>
