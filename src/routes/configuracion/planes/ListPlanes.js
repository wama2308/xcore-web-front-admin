...
class ListPlanes extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            modal: false,
    ...
    openModal = (option, data) => {
        if (option === 1) {
            ...
            this.props.loadPlanIdAction(data._id)
            this.setState({
                option: option,
                modal: true,
    ...
    desactivar(id) {
        const message = {
            ...
            info: "¿Esta seguro que desea inactivar este plan?"
        };
        this.props.confirm(message, res => {
            if (res) {
                this.props.cambiarEstatusPlanFunction(id);
            }
        });
    }
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Planes Activos" fullBlock>
                {
                    this.state.modal &&
                    <ModalPlanes
                ...
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allPlanesFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allPlanesFunction}
                                        />
                                    </div>
                                }
                            </div>
