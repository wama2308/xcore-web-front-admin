...
class ListPlanesDisabled extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            modal: false,
    ...
    activar(id) {
        const message = {
            title: "Activar Plan",
            info: "¿Esta seguro que desea activar este plan?"
        };
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Planes Inactivos" fullBlock>
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allPlanesDisabledFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allPlanesDisabledFunction}
                                        />
                                    </div>
                                }
                            </div>
...
export default ListPlanesDisabled;