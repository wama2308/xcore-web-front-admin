...
class ListDisabled extends React.Component {
    ...
    activar(id) {
        const message = {
            ...
            info: "¿Esta seguro que desea activar este departamento?"
        };
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Departamentos Inactivos" fullBlock>
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allDepartamentsDisabledFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allDepartamentsDisabledFunction}
                                        />
                                    </div>
                                }
                            </div>
