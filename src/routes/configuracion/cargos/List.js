...
const List = props => {
    ...
    const openModal = (option, data) => {
        if (option === 1) {
            ...
            props.loadCargosIdAction(data._id)
            setList({
                option: option,
                modal: true,
    ...
    const desactivar = (id) => {
        const message = {
            ...
            info: "¿Esta seguro que desea inactivar este cargo?"
        };
        props.confirm(message, res => {
            if (res) {
                props.changeEstatusCargosFunction(id);
            }
        });
    }
    ...
    return (
        <RctCollapsibleCard heading="Lista de Cargos Activos" fullBlock>
            {
                list.modal &&
                <Modal
                    option={list.option}
            ...
            <div className="table-responsive">
                <div className="containerGeneral">
                    ...
                    <div className="containerSearch">
                        <SearchInput allFunction={props.allCargosFunction} />
                    </div>
                </div>
                <br />
                {
                            ...
                            </Table>
                            {
                                ...
                                <div>
                                    ...
                                    <Pager
                                        ...
                                        allFunction={props.allCargosFunction}
                                    />
                                </div>
                            }
                        </div>
