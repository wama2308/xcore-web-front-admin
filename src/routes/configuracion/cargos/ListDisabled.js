...
const ListDisabled = props => {
    ...
    return (
        <RctCollapsibleCard heading="Lista de Cargos Inactivos" fullBlock>
            <div className="table-responsive">
                <div className="containerGeneral">
                    ...
                    <div className="containerSearch">
                        <SearchInput allFunction={props.allCargosDisabledFunction} />
                    </div>
                </div>
                <br />
                {
                            ...
                            </Table>
                            {
                                ...
                                <div>
                                    ...
                                    <Pager
                                        ...
                                        allFunction={props.allCargosDisabledFunction}
                                    />
                                </div>
                            }
                        </div>
