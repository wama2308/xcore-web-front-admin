...
class List extends React.Component {
    ...
    openModal = (option, data) => {
        if (option === 1) {
            ...
            this.props.loadClassIdAction(data._id)
            this.setState({
                option: option,
                modal: true,
    ...
    desactivar(id) {
        const message = {
            title: "Inactivar Clase",
            info: "¿Esta seguro que desea inactivar esta clase?"
        };
        this.props.confirm(message, res => {
            if (res) {
                this.props.changeEstatusClassFunction(id);
            }
        });
    }
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Clases Activas" fullBlock>
                {
                    this.state.modal &&
                    <ModalLessons
                ...
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allClassFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allClassFunction}
                                        />
                                    </div>
                                }
                            </div>
