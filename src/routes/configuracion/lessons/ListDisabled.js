...
class ListDisabled extends React.Component {
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Clases Inactivas" fullBlock>
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allClassDisabledFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allClassDisabledFunction}
                                        />
                                    </div>
                                }
                            </div>
