...
const ListProviderEnabled = props => {
    const initialState = {
        modal: false,
        modalHeader: '',
        modalFooter: '',
    ...
    const openModal = (option, data) => {
        if (option === 1) {
            ...
            props.loadProviderIdAction(data._id)
            setList({
                option: option,
                modal: true,
    ...
    return (
        <RctCollapsibleCard heading="Lista de Proveedores Activos" fullBlock>
            {
                list.modal &&
                <ModalProvider
                    option={list.option}
            ...
            <div className="table-responsive">
                <div className="containerGeneral">
                    ...
                    <div className="containerSearch">
                        <SearchInput allFunction={props.allProviderFunction} />
                    </div>
                </div>
                <br />
                {
                            ...
                            </Table>
                            {
                                ...
                                <div>
                                    ...
                                    <Pager
                                        ...
                                        allFunction={props.allProviderFunction}
                                    />
                                </div>
                            }
                        </div>
...
export default ListProviderEnabled