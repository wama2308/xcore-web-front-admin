...
class Services extends React.Component {
    ...
    handleChange = (e, id, type) => {
        ...
        this.props.setDataServicesAction(id, e.target.value, type);
    };
    ...
    handleChangeSelect = (value, select, selectError, id, div) => {
        ...
        this.props.setSelectDataServices(id, value, select);
    };
                        ...
                        <table className="table table-hover" style={{ width: '100%', height: '10vh' }} >
                            <thead>
                                <tr>
                                    ...
                                    <td style={{ width: '15%' }} align="left">Descripcion</td>
                                    ...
                                    <td style={{ width: '5%' }} align="left">Accion</td>
                                </tr>
                            </thead>
                            <tbody>
                                {dataSelect &&
                                    dataSelect.map((data, key) => {
                                        return (
                                            <tr key={key}>
                                                ...
                                                <td style={{ width: '15%' }} align="left">{data.description}</td>
                                                <td style={{ width: '10%' }} align="left">
                                                    <div id={`div_type_comparison_service_${key}`} className="">
                                                        <Input
                                                            invalid={this.state.type_comparison_error}
                                                            id="type_comparison"
                                                            name="type_comparison"
                                                            onKeyUp={event => this.handlekey(
                                                                `div_type_comparison_service_${key}`,
                                                            )}
                                                            onChange={event => this.handleChange(event, data.services_id, "type_comparison")}
                                                            onKeyDown={event => this.keyPress(event, data.services_id, "type_comparison")}
                                                ...
                                                <td style={{ width: '15%' }} align="left">
                                                    <div id={`div_time_cycle_service_${key}`} className="">
                                                        <Select
                                                            isClearable
                                                            isSearchable
                                                ...
                                                <td style={{ width: '10%' }} align="left">
                                                    <div id={`div_time_amount_service_${key}`} className="">
                                                        <Input
                                                            invalid={this.state.time_amount_error}
                                                            id="time_amount"
                                                            name="time_amount"
                                                            onKeyUp={event => this.handlekey(
                                                                `div_time_amount_service_${key}`,
                                                            )}
                                                            onChange={event => this.handleChange(event, data.services_id, "time_amount")}
                                                            onKeyDown={event => this.keyPress(event, data.services_id, "time_amount")}
                                                ...
                                                <td style={{ width: '15%' }} align="left">
                                                    <div id={`div_percentage_service_${key}`} className="">
                                                        <Select
                                                            isClearable
                                                            isSearchable
                                                            isDisabled={this.props.disabled}
                                                ...
                                                <td style={{ width: '15%' }} align="left">
                                                    <div id={`div_percentage_amount_service_${key}`} className="">
                                                        <Input
                                                            ...
                                                            // )}
                                                            onKeyUp={event => this.handlekey(
                                                                `div_percentage_amount_service_${key}`,
                                                            )}
                                                            onChange={event => this.handleChange(event, data.services_id, "percentage_amount")}
                                                            onKeyDown={event => this.keyPress(event, data.services_id, "percentage_amount")}
