...
class ListDisabled extends React.Component {
    ...
    activar(id) {
        const message = {
            title: "Activar Tipo de Cliente",
            info: "¿Esta seguro que desea activar este tipo de cliente?"
        };
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Tipos de Cientes Inactivos" fullBlock>
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allTypeClientDisabledFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allTypeClientDisabledFunction}
                                        />
                                    </div>
                                }
                            </div>
