...
class List extends React.Component {
    ...
    openModal = (option, data) => {
        if (option === 1) {
            this.setState({
                option: option,
                modal: true,
                modalHeader: 'Registrar Tipo de Cliente',
            ...
            this.props.loadTypeClientIdAction(data._id)
            this.setState({
                option: option,
                modal: true,
                modalHeader: 'Ver Tipo de Cliente',
                buttonFooter: 'Editar',
                disabled: true,
                showHide: true,
                data: data,
            ...
            this.setState({
                option: option,
                modal: true,
                modalHeader: 'Editar Tipo de Cliente',
                buttonFooter: 'Editar',
                disabled: false,
                showHide: false,
                data: data,
    ...
    desactivar(id) {
        const message = {
            title: "Inactivar Tipo de Cliente",
            info: "¿Esta seguro que desea inactivar este tipo de cliente?"
        };
        this.props.confirm(message, res => {
            if (res) {
                this.props.changeEstatusTypeClientFunction(id);
            }
        });
    }
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Tipos de Clientes Activos" fullBlock>
                {
                    this.state.modal &&
                    <Modal
                ...
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allTypeClientFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allTypeClientFunction}
                                        />
                                    </div>
                                }
                            </div>
