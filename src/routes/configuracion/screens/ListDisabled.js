...
class ListDisabled extends React.Component {
    ...
    activar(id) {
        const message = {
            ...
            info: "¿Esta seguro que desea activar este monitor?"
        };
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Monitores Inactivos" fullBlock>
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allScreenDisabledFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allScreenDisabledFunction}
                                        />
                                    </div>
                                }
                            </div>
