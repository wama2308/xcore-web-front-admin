...
class ListDisabled extends React.Component {
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Almacenes Inactivos" fullBlock>
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allStoreDisabledFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allStoreDisabledFunction}
                                        />
                                    </div>
                                }
                            </div>
