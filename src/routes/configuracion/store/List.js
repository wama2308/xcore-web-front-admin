...
class List extends React.Component {
    ...
    openModal = (option, data) => {
        if (option === 1) {
            ...
            this.props.loadStoreIdAction(data._id)
            this.setState({
                option: option,
                modal: true,
    ...
    desactivar(id) {
        const message = {
            ...
            info: "¿Esta seguro que desea inactivar este almacen?"
        };
        this.props.confirm(message, res => {
            if (res) {
                this.props.changeEstatusStoreFunction(id);
            }
        });
    }
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Almacenes Activos" fullBlock>
                {
                    this.state.modal &&
                    <Modal
                ...
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allStoreFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allStoreFunction}
                                        />
                                    </div>
                                }
                            </div>
