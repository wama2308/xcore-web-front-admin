...
class List extends React.Component {
    ...
    openModal = (option, data) => {
        if (option === 1) {
            this.setState({
                option: option,
                modal: true,
                modalHeader: 'Registrar Descuento',
            ...
            this.props.loadDiscountsIdAction(data._id)
            this.setState({
                option: option,
                modal: true,
                modalHeader: 'Ver Descuento',
                buttonFooter: 'Editar',
                disabled: true,
                showHide: true,
                data: data,
    ...
    desactivar(id) {
        const message = {
            ...
            info: "¿Esta seguro que desea inactivar este descuento?"
        };
        this.props.confirm(message, res => {
            if (res) {
                this.props.changeEstatusDiscountsFunction(id);
            }
        });
    }
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Descuentos Activos" fullBlock>
                {
                    this.state.modal &&
                    <Modal
                ...
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allDiscountsFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                <Table aria-label="a dense table">
                                    <TableHead className="">
                                        <TableRow hover>
                                            ...
                                            <TableCell style={{ width: '20%' }} align="left">Valor</TableCell>
                                                ...
                                                return (
                                                    <TableRow hover key={i}>
                                                        ...
                                                        <TableCell style={{ width: '20%' }} align="left">
                                                            {data.type.trim() === 'percentage' ? 'Porcentaje' : 'Monto'}
                                                        </TableCell>
                                                        <TableCell style={{ width: '20%' }} align="left">{number_format(data.value, 2)}</TableCell>
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allDiscountsFunction}
                                        />
                                    </div>
                                }
                            </div>
