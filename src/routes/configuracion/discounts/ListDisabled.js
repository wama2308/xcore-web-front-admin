...
class ListDisabled extends React.Component {
    ...
    activar(id) {
        const message = {
            ...
            info: "¿Esta seguro que desea activar este descuento?"
        };
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Descuentos Inactivos" fullBlock>
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allDiscountsDisabledFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allDiscountsDisabledFunction}
                                        />
                                    </div>
                                }
                            </div>
