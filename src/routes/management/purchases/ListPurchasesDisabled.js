...
const ListPurchasesDisabled = props => {
    const initialState = {
        modal: false,
        modalHeader: '',
        modalFooter: '',
    ...
    const activar = (id) => {
        const message = {
            ...
            info: "¿Esta seguro que desea activar este compra?"
        };
    ...
    return (
        <RctCollapsibleCard heading="Lista de Compras Inactivas" fullBlock>
            <div className="table-responsive">
                <div className="containerGeneral">
                    ...
                    <div className="containerSearch">
                        <SearchInput allFunction={props.allPurchasesDisabledFunction} />
                    </div>
                </div>
                <br />
                {
                            ...
                            </Table>
                            {
                                ...
                                <div>
                                    ...
                                    <Pager
                                        ...
                                        allFunction={props.allPurchasesDisabledFunction}
                                    />
                                </div>
                            }
                        </div>
...
export default ListPurchasesDisabled