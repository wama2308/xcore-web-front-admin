...
class List extends React.Component {
    ...
    openModal = (option, data) => {
        if (option === 1) {
            ...
            this.props.loadRolsIdAction(data._id)
            this.setState({
                option: option,
                modal: true,
                modalHeader: 'Ver Rol',
    ...
    desactivar(id) {
        ...
        this.props.confirm(message, res => {
            if (res) {
                this.props.changeEstatusRolsFunction(id);
            }
        });
    }
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Roles Activos" fullBlock>
                {
                    this.state.modal &&
                    <Modal
                ...
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allRolsFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allRolsFunction}
                                        />
                                    </div>
                                }
                            </div>
