...
class ListDisabled extends React.Component {
    ...
    render() {
        ...
        return (
            <RctCollapsibleCard heading="Lista de Roles Inactivos" fullBlock>
                <div className="table-responsive">
                    <div className="containerGeneral">
                        ...
                        <div className="containerSearch">
                            <SearchInput allFunction={this.props.allRolsDisabledFunction} />
                        </div>
                    </div>
                    <br />
                    {
                                ...
                                </Table>
                                {
                                    ...
                                    <div>
                                        ...
                                        <Pager
                                            ...
                                            allFunction={this.props.allRolsDisabledFunction}
                                        />
                                    </div>
                                }
                            </div>
