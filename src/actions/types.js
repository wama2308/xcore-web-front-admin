...
export const ON_SET_CLIENT = "ON_SET_CLIENT";
export const ON_SET_RESULT_ITEMS = "ON_SET_RESULT_ITEMS";
export const ON_SET_PAGES_ITEMS = "ON_SET_PAGES_ITEMS";
export const ON_SET_FOREIGN_EXCHANGE = "ON_SET_FOREIGN_EXCHANGE";
export const ON_SET_LOCAL_CURRENCY = "ON_SET_LOCAL_CURRENCY";
export const ON_SET_VALUE_IN_CURRENCY = "ON_SET_VALUE_IN_CURRENCY";
//crm
